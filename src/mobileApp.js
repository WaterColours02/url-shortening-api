    ...
    <div className="App">
      <div className='header-continer'>
        <header className='header'> 
          ...
          <a className='login header-link'>Login</a>
          <a className='sign-up button-pill'>Sign Up</a>
          </div>
